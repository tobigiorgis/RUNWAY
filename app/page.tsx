...
export default function Home() {
  ...
  return (
    ...
    <main className={`flex h-screen w-full flex-col items-center bg-gray justify-center pt-20 md:gap-2 gap-10`}>
      ...
      <section id="what-is" className="flex w-[100vw] h-auto items-center justify-center gap-8 font-medium flex-col px-4 bg-gray">
        <div className="flex items-center justify-center text-center gap-12 flex-col">
          <Image className="rounded-lg flex mr-100" width={600} height={650} alt="Discover" src={`https://qqdcidmbajmncgqukjhm.supabase.co/storage/v1/object/public/uploads/landing/Group%2048.png?t=2025-01-09T10%3A45%3A46.335Z`} />
          <p className="flex items-center justify-center text-center md:w-2/3 md:text-4xl text-3xl font-semibold text-black font-nanum">
